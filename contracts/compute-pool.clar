;; compute-pool.clar
;; Decentralized Compute Resource Allocation Smart Contract
;; This contract manages the lifecycle of compute resources on the Stacks blockchain,
;; from resource provisioning and allocation to trading and utilization.
;; It creates a transparent, efficient marketplace for compute resources,
;; allowing users to purchase, trade, and utilize computational capacity.
;; ========== Error Constants ==========
